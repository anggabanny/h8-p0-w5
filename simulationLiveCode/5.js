...
function userWeapon(user, weapon) {
  ...
  if (user.job == 'swordman') {
    if (weapon == 'redKnife') {
      user.attack += 100 - 300
    } else if (weapon == 'blackKnife'){
      user.attack += 300 - 100
    } else {
      return 'Invalid weapon'
    }
  } else if (user.job == 'monk') {
    if (weapon == 'emptyBracer') {
      user.attack += 20 - 40
    } else if (weapon == 'brokenArms'){
      user.attack += 40 - 20
    } else {
      return 'Invalid weapon'
    }
  } else if (user.job == 'ninja') {
    if (weapon == 'redKnife') {
      user.attack += 100 - 300
    } else if (weapon == 'blackKnife'){
      user.attack += 300 - 100
    } else if (weapon == 'crimsonSword') {
      user.attack += 800 - 400
    } else if (weapon == 'moonLightSword'){
      user.attack += 800 - 400
    }  else if (weapon == 'starKunai') {
      user.attack += 80 - 340
    } else if (weapon == 'huumaShuriken'){
      user.attack += 340 - 80
    }  else {
      return 'Invalid weapon'
    }
  ...
  return username + ' menggunakan senjata '+ weapon + ' attack menjadi ' + user.attack
